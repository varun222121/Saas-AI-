    ...
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
        <div className='text-center'>
            ...
            <p className='text-grey-500 max-w-lg mx-auto'>
                Everthing you need to create, enhance, and optimize content with
        ...
        <div className='flex flex-wrap mt-10 justify-center'>
            {AiToolsData.map((tool, index)=>(
                ...
                shadow lg border border-grey-100 translate-y-1 translate-all
                duration-100 cursor-pointer' onClick={()=> user && navigate(tool.path)}>
