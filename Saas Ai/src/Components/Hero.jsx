...
const Hero = () => {
  ...
  return (
    ...
    <div className='text-center mb-6'>
      ...
      <p className='mt-4 max-2-xs sm:max-w-lg 2xl-max-w-xl m-auto max-sm:text-xs text-grey-600'>
        Transform your content with oursuit if AI tools.
        write articles, Generate images enhance workflow.
      </p>
    </div>
      ...
      <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-xs'>
        ...
        <button className='bg-white px-10 py-3 rounded-lg border border-grey-300 
        hover:scale-102 active:scale-95 transition cursor-pointer'>Watch demo</button>
      </div>
    <div className='flex items-center gap-4 mt-8 mt-8 mx-auto text-grey-600'>
